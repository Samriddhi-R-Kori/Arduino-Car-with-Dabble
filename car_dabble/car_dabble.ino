...
void loop()
{
  ...
  if (((a > 0 && a <= 90) && r > 1) || (GamePad.isUpPressed()))
  {
  ...
  if (((a > 165 && a <= 270) && r > 1) || (GamePad.isDownPressed()))
  {
  ...
  if (((a >= 0 && a <= 0) && r > 1) || (GamePad.isRightPressed()))
  {
  ...
  if (((a > 90 && a <= 165) && r > 1) || (GamePad.isLeftPressed()))
  {
    Serial.println("left");
    digitalWrite(m1p1, LOW);
    digitalWrite(m1p2, LOW);
